...
jsPsych.plugins['demog-geolocation-US'] = (function() {
  var plugin = {};

  plugin.info = {
    name: 'demog-geolocation-US',
    description: '',
    parameters: {
      questions: {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    display_element.innerHTML = '<style id="jspsych-survey-multi-select-css">' + cssstr + '</style>';
      ...
      display_element.innerHTML += '<select class="crs-country" data-region-id="two" data-default-option="Select a country, man."></select>'  
