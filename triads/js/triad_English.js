...
triads_all_filler_groups = shuffle([triads_fillers_a, triads_fillers_b]);
triads_all_fillers = []
for (var i = 0; i < triads_all_filler_groups.length; i++) {
for (var j = 0; j < triads_all_filler_groups[i].length; j++) {
triads_all_fillers.push(triads_all_filler_groups[i][j]);
}
}

triads_attention_checks = shuffle([
